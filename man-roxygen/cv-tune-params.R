...
#'   variable (including binary) and `"f1_score"`, `"matthews_coeff"` or
#'   `"roc_auc"` when `y` is a binary response variable. `NULL` by default which
#'   uses `"mse"` for numeric variables and `"accuracy"` for categorical
#'   variables.
