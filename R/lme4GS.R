################################################################################
# This file has been taken from the lm4GS github package:
# https://raw.githubusercontent.com/perpdgo/lme4GS/master/pkg_src/lme4GS/R/lmerUvcov.R
################################################################################
...
setClass("lmerUvcov",
  representation = list(resp = "lmerResp", relfac = "list"),
  contains = "merMod"
)
